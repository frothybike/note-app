...
resource "aws_api_gateway_method" "send_mail_api_post" {
  rest_api_id   = aws_api_gateway_rest_api.send_mail_api.id
...
resource "aws_api_gateway_integration" "send_mail_api_post" {
  rest_api_id   = aws_api_gateway_rest_api.send_mail_api.id
  resource_id   = aws_api_gateway_resource.send_mail_api_resource.id
  http_method   = aws_api_gateway_method.send_mail_api_post.http_method
